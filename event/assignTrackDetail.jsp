...
<div class="wapper">
    ...
    <div id="fixId" style="position:fixed; background:white; z-index:10; margin-left: 15px;">
         <div class="now-location" style="padding-left: 0px;"><span class="not-im">当前位置：本级事件&nbsp;>&nbsp;交办跟踪办件&nbsp;>&nbsp;</span><span class="im">事件详情</span></div>
...
<script>
//返回
var pagePath="event-handle/doing";
var closeWin = function(){
    router.setRoute("event/doing");
}
$(function(){
    //办理操作
    ...
    //默认选中批示
    $('#instruct-radio').attr('checked','checked');
    $('#instruct').css('display','block');
    
    //修改   
    /*$('#editDetail').click(function(){
        router.setRoute("common/basicInfo?id=" + id + "&backRoute=event/assignTrackDetail");
    }); */
});
</script>
</html>