...
<div class="wapper">
    ...
    <div id="fixId" style="position:fixed; background:white; z-index:10; margin-left: 15px;">
         <div class="now-location" style="padding-left: 0px;"><span class="not-im">当前位置：本级事件&nbsp;>&nbsp;退单审核件&nbsp;>&nbsp;</span><span class="im">事件详情</span></div>
...
<script>
var pagePath="event-handle/backCheck";
//返回
var closeWin = function(){
    router.setRoute("event/backCheck");
}
$(function(){
	//办理操作
    $('#back-radio').parent().css('display','inline');  //回退
