...
<div class="wapper">
    ...
    <div id="fixId" style="position:fixed; background:white; z-index:10; margin-left: 15px;">
         <div class="now-location" style="padding-left: 0px;"><span class="not-im">当前位置：本级事件&nbsp;>&nbsp;已办结件&nbsp;>&nbsp;</span><span class="im">事件详情</span></div>
...
<script>
var pagePath="event-handle/end";
//返回
var closeWin = function(){  
    router.setRoute("event/end");
}
$(function(){
	//办理操作
    $('#remark-radio').parent().css('display','inline');  //备注
    
    //默认选中备注
    $('#remark-radio').attr('checked','checked');
