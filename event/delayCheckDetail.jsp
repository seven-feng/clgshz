...
<div class="wapper">
    ...
    <div id="fixId" style="position:fixed; background:white; z-index:10; margin-left: 15px;">
         <div class="now-location" style="padding-left: 0px;"><span class="not-im">当前位置：本级事件&nbsp;>&nbsp;延期审核件&nbsp;>&nbsp;</span><span class="im">事件详情</span></div>
...
<script>
var pagePath="event-handle/delayCheck";
//返回
var closeWin = function(){
    router.setRoute("event/delayCheck");
}
$(function(){
	//办理操作
    $('#delayCase-radio').parent().css('display','inline');  //延期审核
    
    //默认选中延期审核
    $('#delayCase-radio').attr('checked','checked');
