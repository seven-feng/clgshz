...
<div class="wapper">
    ...
    <div id="fixId" style="position:fixed; background:white; z-index:10; margin-left: 15px;">
         <div class="now-location" style="padding-left: 0px;"><span class="not-im">当前位置：本级事件&nbsp;>&nbsp;废除件&nbsp;>&nbsp;</span><span class="im">事件详情</span></div>
...
<script>
var pagePath="event-handle/abolish";
//返回
var closeWin = function(){  
    router.setRoute("event/abolish");
}
$(function(){
});
</script>
