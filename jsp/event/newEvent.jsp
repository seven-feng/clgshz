...
<script type="text/javascript" src="<%=basePath%>js/external/FileSaver.js"></script>
<script type="text/javascript" src="<%=basePath%>js/event/treeUsed.js"></script>
<script type="text/javascript" src="<%=basePath%>js/event/newEvent.js"></script>
...
<div class="wapper">
    ...
    <form id="newEvent-form" method="post" enctype="multipart/form-data" >
        ...
        <table class="info-table table">
            ...
            <tr>
                ...
                <td colspan="3"><input name="issueTime" type="text" style="width: 205px;"/></td>
                <!-- <td class="red right subtitle">反映时间：</td>
                <td><input name="issueTime" type="text" class="datepicker" style="width: 205px;"/></td> -->
            ...
            <tr>
                ...
                <td>
                    <select name="eventChannel" style="width: 200px; height: 26px; margin-right: 10px;">
                        <option></option>
                    </select>
                </td>
                <td colspan="2">
            ...
            <tr>
                ...
                <td colspan="2">
                    <select name="firstStatus" style="width: 157px; height: 26px;">
                        <option value=""></option>
                        <option value="0" selected>初</option>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="radio" name="emDegree" value="0" checked/>平急
        ...
        <table class="info-table table" style="margin-top: 30px;">
            ...
            <tr>
                ...
                <td colspan="6">
                    ...
                    <input type="file" id="file" name="file" multiple="multiple" class="change" style="display: none;"/>
                </td>
            </tr>
            </tbody>
        </table>
        ...
        <table class="info-table table">
            ...
            <tr>
                ...
                <td><input name="issueTime" type="text" style="width: 205px;"/></td>
    ...
    <div class="modal-dialog modal-content" style="margin-top: 10%; width: 520px;">
        <div class="modal-header modal-header-adjust">
            <button class="close" data-dismiss="modal" style="width: 14px; margin-top: 11px;"/>
            <span>事件定位</span>
        </div>
        ...
        <div class="modal-footer" style="padding: 5px 10px 5px 0px; border: 1px solid #d6d6d6; background: #f1f1f1;">
            <button class="btn btn-primary btn-sm" id="mapModalBtn">确定</button>
    ...
    <!-- 相似事件查看弹框 -->
	<div id="simModal" class="modal fade">
		<div class="modal-dialog modal-content" style="margin-top: 15%; width: 400px;">
		    <div class="modal-header modal-header-adjust">
	            <button type="button" class="close" data-dismiss="modal" style="width: 14px; margin-top: 11px;"/>
	        </div>
		    <div class="modal-body">
		    <div style="height: 50px; font-size: 14px; text-align: center; padding-top: 20px;">
		                       保存成功，是否查看相似事件？
		    </div>   
		    </div>
		    <div class="modal-footer" style="padding: 5px 10px 5px 0px; border: 1px solid #d6d6d6; text-align: center;">
		        <button type="button" id="simConfirmBtn" class="btn btn-primary btn-sm">查看</button>
		        <button type="button" id="simCancelBtn" class="btn btn-default btn-sm" data-dismiss="modal" style="margin-left: 30px;">取消</button>
		    </div>
		</div>
	</div>
...
$(function(){
    ...
    //回复单位,会出现两个单位同时修改的情况，后面需要修改！
    $("input[name='replyDept']").click(function(){
        var cityObj = $("input[name='replyDept']");
        var cityOffset = $("input[name='replyDept']").offset();
        if($("#menuContent").css("display") == 'none'){
            showMenu(cityObj,cityOffset);
        }else{
            hideMenu();
